...
``main()`` schreibt zunächst die Platzhalter-Evidenz (Status ``platzhalter``);
die eigentlichen Smoke-Auswertungen (GL-Provenance, Retina, ``.deb``-Zyklus)
leben in ``evaluate_*``/``finalize_evidence`` (#642/#643) und werden von
``scripts/abnahme_smoke.py`` gefahren, das die Evidenz zum echten Ergebnis
fortschreibt.
"""
