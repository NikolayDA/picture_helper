...
Die Smoke-Entscheidungslogik (GL-Provenance, Retina, ``.deb``-Zyklus; #642/#643)
liegt weiter unten im Modul: ``build_evidence`` schreibt den Status
``platzhalter``, ``finalize_evidence`` hebt ihn auf ``bestanden``/
``fehlgeschlagen`` an.
"""
