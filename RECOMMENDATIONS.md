...
- **Sofort startbar ohne fremde Abhängigkeit:** #684 (Epic #680), #702, #692 (Epic #682) und das Grundgerüst von #687 (Epic #681, ohne die eigentlichen Hardwaretests).
...
| [#685](https://github.com/NikolayDA/picture_helper/issues/685) | Kandidatenartefakte + Hardware-Abnahme gegen exakten Commit | 🟡 Mittel (Standard-Release-Pipeline mit 5 Artefakten über 3 Plattformen/Architekturen: linux-x86_64, linux-raspberrypi-arm64, macos-arm64) | 🟡 Mittel (bestehende Abnahme-Automation aus Epic #639 wiederverwendbar) | Sonnet, mittel (Build); kein Agent für Hardware-Smokes | Blocked – Freeze erfüllt, wartet noch auf #684 |
...
| [#687](https://github.com/NikolayDA/picture_helper/issues/687) | Annahmeninventar, Herstellerquellen, Testmatrix | 🟠 Hoch (verbindliche Grundlage für #688–#691) | 🟡 Mittel (Recherche/Doku, kein Hardwarezugriff nötig) | Sonnet, mittel | Startbereit (Grundgerüst; Hardwaretests separat) |
