...
## Aktueller Stand (2026-07-26, PR-/Issue-Nachprüfung)

Ruff, mypy und die lokale Testsuite bleiben die Baseline vor neuen PRs. Seit dem letzten Update (2026-07-23) hat der Repo-Owner drei neue Epics mit insgesamt 14 Teil-Issues angelegt. #677 wurde im selben Zeitraum eröffnet und über PR #679 wieder geschlossen. #683 wurde anschließend über PR #698 geschlossen; die Nachprüfung hat jedoch eine inkonsistente Freeze-Basis gefunden und dafür Folge-Issue #699 angelegt. Der Live-Stand liegt damit weiterhin bei **19** offenen Issues:
...
Die Kommentarverläufe von #245 und #656 wurden erneut geprüft: keine neuen Kommentare seit dem letzten Stand (#245 zuletzt 2026-07-15, #656 nie); beide bleiben unverändert reine externe/operative Tracker ohne Code-Bezug. Die vier am 2026-07-26 gemergten PRs #678, #679, #697 und #698 hatten grüne PR-CI-, CodeQL-, Dependency- und Lizenzprüfungen. #678/#679 sind fachlich sauber; #697 hat alle drei Reviewhinweise im finalen Commit behoben. Bei #698 fehlen dagegen der tatsächliche 2.7.1-Kandidat im Commit-Inventar, der vollständige SHA und eine eingereichte unabhängige Review; Details und Akzeptanzkriterien stehen in #699.

Live-Stand nach GitHub-Abfrage: **19** offene Issues (16 aus #680–#696; dazu #699 sowie #656/#245 unverändert extern).

### Ergebnis der Nachprüfung

- **Keine neuen Kommentare** an #245/#656 seit der letzten Runde – kein Update an diesen Issues nötig.
- **Die offenen Issues sind vollständig spezifiziert:** jedes enthält Kontext, Ziel, Nicht-Ziele/Abgrenzung und eine detaillierte Akzeptanzkriterien-Liste. Der begrenzende Faktor sind reale Abhängigkeiten: Epic #681 (EufyMake) braucht physische Zielhardware für #688–#690, Epic #680 braucht zuerst die Freeze-Korrektur #699 und den Regressionsnachweis #684, und Epic #682 braucht den ADR (#692) vor jeder Implementierung.
- **Sofort startbar ohne fremde Abhängigkeit:** #699 und #684 (Epic #680) sowie #692 (Epic #682) und das Grundgerüst von #687 (Epic #681, ohne die eigentlichen Hardwaretests).
...
|---|-------|----------|--------------|-------------------------------|-------------------|
| [#680](https://github.com/NikolayDA/picture_helper/issues/680) | [Epic] v2.7.x-Stabilisierung – GL-Fix veröffentlichen | 🟠 Hoch (bringt gemergten GL-Ressourcenfix an Nutzer) | 🟠 Hoch (Release-Pipeline + Hardware-Abnahme) | – (Epic; Sonnet, mittel zur Nachverfolgung) | In Bearbeitung – #699/#684 zuerst abschließen |
| [#699](https://github.com/NikolayDA/picture_helper/issues/699) | Freeze-Commit auf tatsächlichen 2.7.1-Kandidaten korrigieren | 🟠 Hoch (verhindert Build/Tag gegen den noch als 2.7.0 ausgewiesenen Commit) | 🟡 Mittel (Commit-Inventar, Release Notes, Gates und unabhängige Review synchronisieren) | Opus, mittel | Sofort starten – blockiert #685/#686 |
...
| [#685](https://github.com/NikolayDA/picture_helper/issues/685) | Kandidatenartefakte + Hardware-Abnahme gegen exakten Commit | 🟡 Mittel (Standard-Release-Pipeline mit 5 Artefakten über 3 Plattformen/Architekturen: linux-x86_64, linux-raspberrypi-arm64, macos-arm64) | 🟡 Mittel (bestehende Abnahme-Automation aus Epic #639 wiederverwendbar) | Sonnet, mittel (Build); kein Agent für Hardware-Smokes | Blocked – wartet auf #699 + #684 |
...
1. **#699** (Freeze-Korrektur 2.7.1) zuerst abschließen – der bisherige Freeze-Commit ist noch Version 2.7.0 und darf nicht Grundlage von #685/#686 sein.
2. **#684** (GL-Ressourcen-/Regressionstest) parallel zu #699 starten – einziger belastbarer Nachweis für PR #676, unabhängig vom Versionsschnitt.
