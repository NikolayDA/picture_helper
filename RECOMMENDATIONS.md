...
- **#583/#586/#591 abgeschlossen, #584 wieder geöffnet:** Scope-Freeze/Version/CHANGELOG für v2.6.0 (#583), das 16-Bit-HEIGHT-ADR (#586) und der 3D-ADR/UX-Vertrag (#591, PR #603) sind abgeschlossen. #584 bleibt bis zum belegten vollständigen Kandidaten-Gate offen.

### Noch offen

- **Release-Gate #584 🟠:** finalen Kandidaten-SHA festhalten, fünf reale Artefakte im nicht veröffentlichenden Workflow bauen, Prüfsummen und Plattform-Smokes dokumentieren und Go-/No-Go entscheiden.
...
Live-Stand: **17** offene Issues. **#591** ist über PR #603 abgeschlossen; **#584** wurde nach dem Audit wieder geöffnet, weil der vollständige Kandidaten-Gate weiterhin aussteht, und **#585** bleibt dadurch blockiert. Die Owner-Kommentare vom 2026-07-15 auf **#245**/**#551** und die entsprechend geschärften Issue-Bodys bleiben aktuell.
...
| [#584](https://github.com/NikolayDA/picture_helper/issues/584) | Release 2.6.0: Kandidaten-Gate, fünf Artefakte | 🟠 Hoch | 🟠 Hoch | Sonnet 5 · hoch | **In Arbeit (wieder geöffnet)** – finalen Kandidaten-SHA fixieren, nicht veröffentlichenden Fünf-Artefakt-Lauf mit Prüfsummen/Smokes ausführen und Go-/No-Go dokumentieren. |
...
1. **#584** — den wieder geöffneten Kandidaten-Gate vollständig abschließen: finalen SHA, fünf reale Artefakte, Prüfsummen, Plattform-Smokes und Go-/No-Go belegen.
...
*Drift-Hinweis:* Der Live-Nachzug hat die vorzeitige Schließung von #584 und den tatsächlichen Abschluss von #591 sichtbar gemacht. #584 ist wieder geöffnet; künftige Updates müssen Status, Checklisten und Abhängigkeiten erneut live prüfen statt nur einen Zeitstempel fortzuschreiben.
