...
def _u2net_home() -> Path:
    """Rembg-Cache-Verzeichnis: `U2NET_HOME`-Override oder `~/.u2net`."""
...
def get_model_status() -> ModelStatusResult:
    ...
    `U2NET_HOME`, falls gesetzt, sonst `~/.u2net`. Keine Integritätsprüfung
    (Checksumme) in v1, nur Existenz + Größe > 0.
    """
