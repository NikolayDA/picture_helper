...
Bibliothek, entweder das Distributionspaket `libfuse2` beziehungsweise
`libfuse2t64` installieren oder ohne FUSE starten:
...
- **AppImage meldet `dlopen(): error loading libfuse.so.2` oder
  ...
  `libfuse2` oder `libfuse2t64` installieren oder das AppImage ohne FUSE mit
