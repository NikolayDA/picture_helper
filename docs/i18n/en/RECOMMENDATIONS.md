...
Unchanged and closed: **N1/N2/N4/N5/N6/N7/N8**, **O1–O8**, everything completed since **2026-06-25**, releases v2.7.0–v2.9.0, epic #741 with its eleven sub-issues, epic #805 with #806–#811, #817, and #821; newly closed since the last sync: #943 (PR #944), #692 (PR #947), plus the ANLEITUNG review #963 with #964–#966, #968, and #969 (PR #972) and #967 (PR #973) (details: Previous Rounds).
...
| [#974](https://github.com/NikolayDA/picture_helper/issues/974) | Guard ANLEITUNG.pdf against ANLEITUNG.md (missing check) | 🟡 Medium (the shipped manual PDF can go stale; the drift really happened with #953) | 🟢 Low (one network-free test plus a docs line; a byte comparison is ruled out) | Sonnet, medium | Ready to start – implement the git co-change guard; red proof at `ac64c3b`, green against `91b32b4` and HEAD |
