...
Unchanged and closed: **N1/N2/N4/N5/N6/N7/N8**, **O1–O8**, everything completed since **2026-06-25**, releases v2.7.0–v2.9.0, epic #741 with its eleven sub-issues, epic #805 with #806–#811, #817, and #821; newly closed since the last sync: #943 (PR #944), #692 (PR #947), plus the ANLEITUNG review #963 with #964–#966, #968, and #969 (PR #972) and #967 (PR #973), plus the test-suite audit #949 (PR #977) and the PDF guard #974 (PR #979), plus the staged heartbeat escalation #958 (PR #981) (details: Previous Rounds).
