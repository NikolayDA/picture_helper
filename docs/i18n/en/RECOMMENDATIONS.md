...
| [#690](https://github.com/NikolayDA/picture_helper/issues/690) | Validate gloss/clear-coat semantics | 🟡 Medium (gloss is already flagged "experimental" in code) | 🔴 High (physical prints, material consumption) | – (no agent; needs real hardware) | Blocked (external) + groundwork complete – schema 4 covers absent/0/128/255, limited wedge, dimensions, Alpha×Gloss, HEIGHT×Gloss, and registration; Studio import and physical gloss evidence remain open |
