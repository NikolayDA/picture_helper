...
remain the baseline before new PRs. New this round: the open-issue triage has
been brought current after the rail/zoom follow-ups. Before this PR, GitHub
shows 14 open issues; after closing **#461**, 13 roadmap/backlog issues remain.
...
- **Rail/zoom wave completed:** **#455/#456/#457/#458/#463/#464** landed via
  PR #466, and **#465** is intentionally `not_planned`. This follow-up PR closes
  the three late #466 P2s (zoom direction, viewport anchor, height-dab preview)
  and refreshes **#461**.
...
## Open GitHub Issues — Triage Status (2026-07-03)

As of 2026-07-03, GitHub shows **14** open issues before this follow-up merges.
**#461** is exactly this snapshot drift and is closed by the PR. For planning,
that leaves **13** open roadmap/backlog issues: right-column polish
(**#413/#414**), i18n/docs (**#425/#430/#431/#432**), rollout/release
...
| [#461](https://github.com/NikolayDA/picture_helper/issues/461) | Refresh triage snapshot after rail follow-ups | 🟡 Medium | 🟢 Low | **Resolved by this PR** – will close. |
