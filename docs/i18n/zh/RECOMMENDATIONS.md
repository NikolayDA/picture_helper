...
GitHub 查询后的实时状态：**23** 个未结议题——#737/#745/#746/#762/#769 已关闭，#758 为新增。
...
3. **#752** 仍保持独立；**#656** 与 **#731** 均已决策（方案 A）并已落地，各自仅剩下一次运行中的证明。#752 应改为验证新的清单/批准清单契约，而非手工状态。
