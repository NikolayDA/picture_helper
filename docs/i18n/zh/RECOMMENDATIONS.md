...
**#461** 已关闭——其底层快照漂移已由 PR #467 修复，但该议题本身在合并后仍保持开放。
GitHub 现在显示 **13** 个开放的路线图/Backlog 议题。
...
截至 2026-07-04，GitHub 显示 **13** 个开放的路线图/Backlog 议题：右栏润色
（**#413/#414**）、i18n/文档（**#425/#430/#431/#432**）、rollout/发布
（**#426/#435/#392/#389**），以及独立事项 **#299/#318/#245**。**#461** 正是
这次快照漂移，已于本轮关闭（快照已由 PR #467 修正）。
