...
现有 **三** 个开放 issue。**#176 已完成**（代码质量见 PR #198，
`app.py`/`main_window.py` 测试见 PR #214），**#166/#178/#185 同样完成**
（docstring 清理见 PR #219，诊断脱敏见 PR #220，测试解耦见 PR #221），
**#205/#206 已关闭**（固定由 PR #222 的测试加固）；#199/#200/#201/#202
此前已完成（PR #215/#209/#211）。`pip-audit` 安全批次（2026-06-07，#200–#206）
仅剩观察项 #203/#204 开放；#195 已关闭并验证。
...
4. **#176 已完成（PR #198/#214）** — 已收窄 `E741`、逐步启用 `check_untyped_defs`、新增 cancel_ai 状态提示、`shutdown_all` 清空线程引用；为 `app.py`/`main_window.py` 新增专属测试。
