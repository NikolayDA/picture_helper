...
3. **构建并验收 v2.9.0 发布** —— 运行手册第 1–2 步已完成：版本 2.9.0、六种语言的带发布说明的日期化 CHANGELOG 章节、AppStream/许可证快照，以及[范围冻结文档](../../history/RELEASE-2.9.0-scope-freeze.md)（基线 v2.8.0，路径策略 6）。接下来：通过 `release-linux.yml` 构建候选版本，然后在真实硬件上运行 `release-abnahme.yml`。
