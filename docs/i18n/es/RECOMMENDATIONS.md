...
**EufyMake #681/#687–#691:** el PR #951 está fusionado y #690 amplía el conjunto reproducible a 41 fixtures individuales y siete paquetes de exportación reales. DPI X/Y separados, conflictos de manifiesto/`pHYs`, Gloss 0/128/255, normalización 64…192, dimensiones divergentes, Alpha×Gloss y HEIGHT×Gloss están cubiertos por pruebas automáticas. Studio 4.2.2 confirma el contrato de importación de #689; las nuevas importaciones de #690 y todas las mediciones físicas de Gloss/HEIGHT siguen abiertas. #687 está en 17/18 criterios y espera la revisión final tras las pruebas reales.
...
| [#690](https://github.com/NikolayDA/picture_helper/issues/690) | Validar semántica de gloss/barniz | 🟡 Media (gloss ya está marcado como "experimental" en el código) | 🔴 Alta (impresiones físicas, consumo de material) | – (sin agente; requiere hardware real) | Bloqueada (externa) + preparación completa: el esquema 4 cubre ausente/0/128/255, cuña limitada, dimensiones, Alpha×Gloss, HEIGHT×Gloss y registro; quedan la importación en Studio y la evidencia física |
