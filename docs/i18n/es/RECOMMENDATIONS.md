...
3. **#167 Medium** — Double-checked lock en `_ensure_rembg_remove()` + ventana TOCTOU en `open_validated_image`: implementado en **PR #174** (merge pendiente; hallazgos Low aparte).
