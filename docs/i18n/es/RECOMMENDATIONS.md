...
1. **#595** — se cumplen todos los puntos de la lista "sigue abierto"; la fila x86_64 sigue "pausada/declarada abierta", pero, según una decisión explícita, no bloquea el cierre (reflejando el propio criterio de aceptación de #639).
...
Además, desde la última ronda han aparecido dos incidencias nuevas de auditorías automatizadas (**#659**, **#660**), aún pendientes de decisión.
...
- **#659/#660 son nuevas y siguen sin decidir:** #660 ya tiene un arreglo terminado pero sin fusionar en la rama `claude/festive-gates-4dkzds` (commit `80b7aa0`); #659 es un análisis puro sin cambios de código que propone dos identificadores de hallazgo nuevos (**N9**/**O8**), aún pendientes de aprobación del propietario.
