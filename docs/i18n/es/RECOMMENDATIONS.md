...
**EufyMake #681/#687–#691:** el PR #948 está fusionado y la preparación de #689 aporta 36 fixtures individuales más un paquete de exportación real de cuatro archivos. DPI X/Y separados, valores de manifiesto/`pHYs` deliberadamente contradictorios y marcadores COLOR/HEIGHT/GLOSS pixel a pixel están cubiertos por pruebas automáticas. Hay dos rutas de Studio 4.2.2 documentadas sin imprimir. #687 sigue en 16/18 criterios: I-06 aún necesita observación real en Studio y después la revisión final. El uso completo de 16 bits, la prioridad de tamaño, las medidas físicas en mm, el mapeo de grises a mm y la intensidad de gloss siguen siendo preguntas de hardware de #688–#690.
...
| [#689](https://github.com/NikolayDA/picture_helper/issues/689) | Validar contrato de mm/DPI, tamaño objetivo y posicionamiento | 🟠 Alta (tamaño de impresión/registro) | 🔴 Alta (mediciones físicas, motivos de control) | – (sin agente; requiere hardware real) | En curso: preparación del repositorio completa con 36 fixtures, manifiesto de exportación real, DPI X/Y y registro COLOR/HEIGHT/GLOSS verificados. Faltan importaciones controladas en Studio, observaciones de prioridad/redondeo y mediciones físicas |
...
3. Importar **#689** en Studio de forma controlada y después —solo tras aprobar dispositivo y
   material— medirlo junto con el resto de #687, #688 y #690.
