...
**EufyMake #681/#687–#691:** los PR #948, #951–#953, #956 y #959 están fusionados. Las 27 celdas obligatorias de importación sin impresión están completas en Studio 4.2.2. Además de HEIGHT nativo de 8/16 bits, el recorte COLOR/HEIGHT y `Gloss Varnish`, queda probado que se aceptan dimensiones de píxel distintas con la misma relación de aspecto, mientras que una relación HEIGHT diferente se rechaza con `Depth image ratio does not match the original image`. I-09 (`.empf`) sigue sin bloquear. Solo faltan las mediciones físicas E1 de #688–#690 y la revisión final de #687.
