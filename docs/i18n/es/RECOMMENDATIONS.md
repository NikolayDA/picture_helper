...
Sin cambios y cerrado: **N1/N2/N4/N5/N6/N7/N8**, **O1–O8**, todo lo completado desde **2026-06-25**, las versiones v2.7.0 a v2.9.0, además de la épica #741 con sus once sub-incidencias, la épica #805 con #806–#811, #817 y #821; cerradas desde la última sincronización: #943 (PR #944), #692 (PR #947), además de la revisión de ANLEITUNG #963 con #964–#966, #968 y #969 (PR #972) y #967 (PR #973), además de la auditoría de la suite de pruebas #949 (PR #977) (detalles: Rondas anteriores).
...
| [#974](https://github.com/NikolayDA/picture_helper/issues/974) | Proteger ANLEITUNG.pdf frente a ANLEITUNG.md (falta guardia) | 🟡 Media (el PDF del manual entregado puede quedar obsoleto; la deriva ya ocurrió con #953) | 🟢 Baja (una prueba sin red más una línea de documentación; la comparación por bytes queda descartada) | Sonnet, medio | Listo para empezar – implementar la guardia git de cambio conjunto; prueba en rojo con `ac64c3b`, verde con `91b32b4` y HEAD |
