...
| [#606](https://github.com/NikolayDA/picture_helper/issues/606) | docs: faltan update check/gestión del modelo IA en ANLEITUNG | 🟢 Baja | 🟢 Baja | Sonnet 5 · baja | **Ready for PR** – checklist completa en el issue; actualizar juntas las seis versiones lingüísticas. |
