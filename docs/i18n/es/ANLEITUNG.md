...
- **Generar mapa de altura desde la imagen** – convierte de forma determinista la imagen
...
- **Mapa de altura** (opcional) en escala de grises con **claro = alto,
  ...
  altura* (p. ej. una capa de altura creada con "Generar mapa de altura
  desde la imagen"; una simple capa de altura sin ese rol no se exporta).
...
2. En el paso *Relieve y capas*, **Generar mapa de altura desde la imagen**.
