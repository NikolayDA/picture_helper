...
*Діалог налаштувань: мова інтерфейсу, типові теки для відкриття та збереження,
бажаний формат зображення і шлях до файлу журналу з кнопкою «Відкрити теку».*

| Налаштування | Опис |
|---|---|
| **Мова** | Мова інтерфейсу: німецька або англійська (діє з наступного запуску) |
...
Мова, теки та формат зберігаються між перезапусками програми.
