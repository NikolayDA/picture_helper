...
9. [Вкладка «Поворот/Дзеркало»](#9-вкладка-поворотдзеркало)
10. [Вкладка «Форма» – Кути та обрізання](#10-вкладка-форма--кути-та-обрізання)
11. [Збереження зображення](#11-збереження-зображення)
12. [Налаштування](#12-налаштування)
13. [Гарячі клавіші](#13-гарячі-клавіші)
14. [Типові робочі процеси](#14-типові-робочі-процеси)
15. [Поради та хитрощі](#15-поради-та-хитрощі)
16. [Відомі обмеження](#16-відомі-обмеження)
17. [Усунення неполадок і файл журналу](#17-усунення-неполадок-і-файл-журналу)
18. [Ліцензія](#18-ліцензія)
...
редагування фонів**. Основні функції:
...
![BgRemover – головне вікно після запуску](../../../app_screenshots/bgremover_complete_20260528_214013/01_main_empty.png)
...
| Зона | Призначення |
|---|---|
| **Рядок меню** (вгорі) | Файл, Редагування, Вигляд, Додатково |
...
| **Панель вкладок** (праворуч) | Чотири вкладки: Виділення, Фон, Поворот/Дзеркало, Форма |
| **Рядок стану** (внизу) | Підказки та повідомлення програми |

### Меню «Редагування» та «Вигляд»

Багато дій також доступні через рядок меню:

- **Редагування** – скасувати/повторити, поворот (90° ліворуч/праворуч),
  горизонтальне/вертикальне дзеркалення, а також зняти/інвертувати виділення
  та *Відновити оригінал*. Зручно, коли ви віддаєте перевагу меню перед
  панеллю інструментів або вкладкою.
- **Вигляд** – *Вписати у вікно* (⌘0); див. «Масштаб і вигляд» нижче.

![Меню «Редагування»](../../../app_screenshots/bgremover_complete_20260528_214013/22_menu_edit.png)
...
![Результат видалення фону за допомогою ШІ](../../../app_screenshots/bgremover_complete_20260528_214013/54_function_ai_result.png)
...
Є три способи завантажити зображення:
...
![Меню «Файл»](../../../app_screenshots/bgremover_complete_20260528_214013/20_menu_file.png)

*Меню «Файл» містить Відкрити (⌘O), «Останні файли», Зберегти (⌘S) та
Зберегти як… (⇧⌘S).*

Під час відкриття підтримуються поширені формати: PNG, JPEG, WebP, TIFF,
BMP і GIF; збереження — у PNG, JPEG, WebP або TIFF. Великі
...
![Спливне вікно «Історія змін»](../../../app_screenshots/bgremover_complete_20260528_214013/40_popup_history.png)
...
![Завантажене зображення з активним виділенням](../../../app_screenshots/bgremover_complete_20260528_214013/02_main_loaded_selection.png)
...
Перша вкладка правої панелі керує поведінкою виділення; її вже видно в огляді
вище ([розділ 2](#2-вікно-програми--огляд)) і на ілюстрації в [розділі 6](#6-виділення).
...
![Вкладка «Фон»](../../../app_screenshots/bgremover_complete_20260528_214013/11_tab_background.png)
...
![Діалог вибору кольору](../../../app_screenshots/bgremover_complete_20260528_214013/31_dialog_color_picker.png)
...
## 9. Вкладка «Поворот/Дзеркало»

![Вкладка «Поворот/Дзеркало»](../../../app_screenshots/bgremover_complete_20260528_214013/12_tab_transform.png)
...
> ліворуч) і ⌘→ (90° праворуч).

---

## 10. Вкладка «Форма» – Кути та обрізання

![Вкладка «Форма»](../../../app_screenshots/bgremover_complete_20260528_214013/13_tab_shape_crop.png)
...
![Активне кругле обрізання з панеллю підтвердження](../../../app_screenshots/bgremover_complete_20260528_214013/61_crop_circle_overlay.png)
...
## 11. Збереження зображення

- **Зберегти:** `Файл → Зберегти` (⌘S / Ctrl+S)
- **Зберегти як…:** `Файл → Зберегти як…` (⇧⌘S)

Виберіть потрібний **формат файлу** у діалозі:
...
- **Кольоровий мотив** (обов’язково) як RGBA PNG із кольорового композиту.
- **Карта висот** (необов’язково, лише за наявності шару висоти) у відтінках
  сірого зі **світле = високе, темне = низьке**.
- **Маска глянцю** (необов’язково, експериментально) як допоміжний ресурс.

Діалог перевіряє проєкт **перед** записом: помилки блокують експорт, попередження
потрібно свідомо підтвердити. Далі ви імпортуєте та розташовуєте ресурси в EufyMake
Studio, призначаєте там режими чорнила/шари й зберігаєте проєкт Studio як `.empf`.
...
![Діалог налаштувань](../../../app_screenshots/bgremover_complete_20260528_214013/30_dialog_settings.png)
...
## 17. Усунення неполадок і файл журналу
...
| Зображення не відкривається | Понад 40 мегапікселів? Формат підтримується? Читайте рядок стану |
