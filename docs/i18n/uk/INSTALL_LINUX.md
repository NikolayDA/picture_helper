...
> **Системна вимога артефактів aarch64 (починаючи з v2.10.0):** вбудований
> там Qt потребує **glibc 2.39**, тобто **Raspberry Pi OS «Trixie»
> (Debian 13) або новішої**. На «Bookworm» (Debian 12) `.deb` відмовляє у
> встановленні замість того, щоб упасти пізніше під час запуску; там варто
> скористатися шляхом через apt нижче або оновити систему. Артефактів
> x86_64 це **не** стосується.
