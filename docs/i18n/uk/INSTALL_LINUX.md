...
> **Примітка щодо доступності:** Готові артефакти AppImage/`.deb` доступні
> починаючи з **v2.3.0**. Старіші релізи (наприклад, v2.2.0) ще не містять
> таких assets — доки на сторінці релізів немає нічого для завантаження,
> користуйтеся способом через venv/Git нижче.
