...
Тепер **три** відкриті issues. **#176 виконано** (якість коду у PR #198,
тести `app.py`/`main_window.py` у PR #214), **#166/#178/#185** так само
(docstrings у PR #219, редагування діагностики у PR #220, відв'язка тестів у
PR #221), **#205/#206 закрито** (піни закріплено тестами у PR #222);
#199/#200/#201/#202 виконано раніше (PR #215/#209/#211). З батчу `pip-audit`
від 2026-06-07 (#200–#206) відкритими лишаються тільки спостережні пункти
#203/#204; #195 лишається закритим і верифікованим.
...
4. **#176 виконано (PR #198/#214)** — `E741` звужено, `check_untyped_defs` увімкнено поступово, статусне повідомлення для cancel_ai, `shutdown_all` обнуляє thread-посилання; виділені тести для `app.py`/`main_window.py`.
