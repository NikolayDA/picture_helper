...
| [#177](https://github.com/NikolayDA/picture_helper/issues/177) | Продовження тест-аудиту (Medium): поведінкові assertions + прогалини покриття | 🟠 Висока | 🟡 Середня | Готово до PR (з #168) |
...
| [#161](https://github.com/NikolayDA/picture_helper/issues/161) | Аудит README: зламане посилання та внутрішній жаргон | 🟡 Середня | 🟢 Низька | Жаргон «Runde 5» виправлено; URL клонування відкладено (рішення власника) |
...
3. **#177** — Зміцнення тестів: додати поведінкові assertions + закрити прогалини покриття (з #168).
