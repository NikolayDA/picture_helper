...
Тепер **десять** відкритих issues. **#200/#201/#202 виконано** (build-бекенд
запінено в PR #209, pip-пін у PR #211). Батч безпеки `pip-audit` від 2026-06-07
(#200–#206) та знахідка мертвого коду (#199) лишаються в тріажі; #195 закрито й
верифіковано.
