...
зовні) і низькопріоритетна гігієна тестів **#299**, а також три наслідки зміцнення на
боці repo з тріажу **#245** — **#322** (шлях обслуговування/skip), **#323**
(тести security-issue-sync) і **#324** (governance обсягу prompt); з них
#323/#324 не потребують мережі й здійсненні одразу. Усі відкриті issues
перевірено повторно проти поточного коду.
...
3. **#245** — відновити quota на боці акаунта (заблоковано зовні).
4. **#322** — шлях обслуговування/skip після свідомого рішення auto/manual (наслідок #245).
5. **#323 / #324** — зміцнення без мережі: тести sync і governance prompt, здійсненно будь-коли.
