...
та `.github/workflows/license-check.yml`. Pull request запускає легкий
job на Ubuntu/Python 3.12; повна матриця працює на Ubuntu + macOS з
Python 3.10/3.12 для release або ручних запусків; workflow ліцензій
генерує звіт про залежності/ліцензії.
