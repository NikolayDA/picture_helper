...
# Aperçu des licences et aspects juridiques – bgremover 2.0.0

> Généré automatiquement – **une évaluation purement technique des conditions de licence, pas un conseil juridique.**
> Au : 2026-05-17 · Licence propre du projet : `GPL-3.0-or-later` · 44 dépendances analysées.
...
| urllib3 | 2.6.3 | `MIT` | Permissive | Licence permissive. L'utilisation, la modification et la redistribution – y compris à des fins commerciales et dans des produits propriétaires – sont autorisées tant que les mentions de copyright et de licence sont conservées. |
