...
**EufyMake #681/#687–#691 :** la PR #948 est fusionnée et la préparation #689 fournit désormais 36 fixtures individuels plus un vrai paquet d'export de quatre fichiers. Les DPI X/Y séparés, les valeurs manifeste/`pHYs` volontairement contradictoires et les repères COLOR/HEIGHT/GLOSS pixel à pixel sont couverts automatiquement. Deux parcours Studio 4.2.2 sont documentés sans impression. #687 reste à 16/18 critères : I-06 nécessite encore l'observation réelle dans Studio, puis la revue finale. L'usage complet des 16 bits, la priorité de taille, les mesures physiques en mm, la conversion gris→mm et l'intensité du gloss restent des questions matérielles de #688–#690.
...
| [#689](https://github.com/NikolayDA/picture_helper/issues/689) | Valider le contrat mm/DPI, taille cible, positionnement | 🟠 Élevée (taille d'impression/registration) | 🔴 Élevée (mesures physiques, motifs de contrôle) | – (aucun agent ; matériel réel requis) | En cours : préparation du dépôt complète avec 36 fixtures, vrai manifeste d'export, DPI X/Y et enregistrement COLOR/HEIGHT/GLOSS vérifiés. Restent les imports Studio contrôlés, les observations de priorité/arrondi et les mesures physiques |
...
3. Importer **#689** de façon contrôlée dans Studio puis — seulement après validation du matériel
   et de l'appareil — le mesurer avec le reste de #687, #688 et #690.
