...
| [#683](https://github.com/NikolayDA/picture_helper/issues/683) | Gel de périmètre, coupe de version, notes de release 2.7.1 | 🟠 Élevée (prérequis pour tout le release correctif) | 🟢 Faible (revue de diff + métadonnées de version, processus établi) | Sonnet, moyen | Prêt pour PR |
| [#684](https://github.com/NikolayDA/picture_helper/issues/684) | Test de longue durée/ressources GL et gate de régression | 🟠 Élevée (seule preuve solide pour le PR #676) | 🟡 Moyenne-élevée (instrumentation/mesure des ressources GL, exécution longue) | Opus, élevé | Prêt pour PR |
| [#685](https://github.com/NikolayDA/picture_helper/issues/685) | Construire les artefacts candidats + recette matérielle contre le commit exact | 🟡 Moyenne (pipeline de release standard sur 5 plateformes) | 🟡 Moyenne (automatisation de recette existante de l'épopée #639 réutilisable) | Sonnet, moyen (build) ; pas d'agent pour les smoke tests matériels | Bloqué – attend #683 + #684 |
...
| [#687](https://github.com/NikolayDA/picture_helper/issues/687) | Inventaire des hypothèses, sources du fabricant, matrice de tests | 🟠 Élevée (base contraignante pour #688–#691) | 🟡 Moyenne (recherche/documentation, aucun accès matériel requis) | Sonnet, moyen | Prêt pour PR (ossature ; tests matériels à part) |
...
| [#692](https://github.com/NikolayDA/picture_helper/issues/692) | ADR + contrat de données pour tonalité/histogramme/niveaux de gris | 🟠 Élevée (fixe le contrat pour toute l'épopée) | 🟡 Moyenne (décision d'architecture, pas d'implémentation) | Opus, élevé | Prêt pour PR |
