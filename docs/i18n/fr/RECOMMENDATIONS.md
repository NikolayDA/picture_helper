...
- **#583/#586/#591/#584 achevés :** le scope-freeze/version/CHANGELOG v2.6.0 (#583), l'ADR HEIGHT 16 bits (#586), le contrat ADR/UX 3D (#591, PR #603) et le gate candidat v2.6.0 (#584 : cinq artefacts réels, SHA-256, smokes plateforme natifs, décision Go, commit `427725477d`) sont achevés ; **#585** est débloqué.
...
État en direct : **16** tickets ouverts. **#591** est achevé via PR #603 ; **#584** est clos après le véritable gate candidat (cinq artefacts, SHA-256, smokes natifs), donc **#585** est désormais débloqué. Les commentaires propriétaire du 2026-07-15 sur **#245**/**#551** et leurs corps de ticket resserrés restent valides.

### Regroupements pertinents

- **Release v2.6.0** (#580 → #585 ; #583/#584 déjà clos) : publie l'état déjà construit des mises à jour/gestion IA depuis `main` ; priorité maximale vu le faible risque et la valeur utilisateur immédiate.
...
|---|-------|------------|------------|----------------|-----------------------------|
| [#580](https://github.com/NikolayDA/picture_helper/issues/580) | [Epic] Release v2.6.0 | 🟠 Élevée | 🟠 Élevée | – (epic de suivi) | **In progress** – avance via #585 (#583/#584 clos), pas de PR propre. |
| [#585](https://github.com/NikolayDA/picture_helper/issues/585) | Release 2.6.0 : tag, GitHub Release, vérification post-release | 🟠 Élevée | 🟡 Moyenne | Sonnet 5 · moyen | **Ready for PR** – #584 est achevé, aucune dépendance ouverte ne reste. |
...
1. **#585** — poser le tag `v2.6.0` et publier la release GitHub : #584 est achevé, aucune dépendance ouverte ne reste.
...
5. Tous les sous-tickets 16 bits/3D restants suivent leurs dépendances de façon séquentielle (en attente de #585) – voir le tableau, aucun déclencheur supplémentaire nécessaire.

*Dérive :* le suivi en direct du 2026-07-16 a révélé la clôture prématurée de #584 et l'achèvement réel de #591 ; #584 a été rouvert en conséquence et est désormais clos avec les preuves du véritable gate à cinq artefacts. Les futures mises à jour continuent de revérifier statuts, checklists et dépendances en direct plutôt que de reporter un horodatage.

## Tours précédents

- **2026-07-16 (gate candidat)** — #584 clos via le véritable gate à cinq artefacts (SHA `427725477d`, exécution CI 29488035790, SHA-256 + analyse de secrets par artefact, smokes plateforme natifs) ; #585 débloqué ; état en direct 16.
