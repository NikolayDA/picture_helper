...
État en direct après la clôture post-release : **15** tickets ouverts. Release v2.6.0 et **#580/#585** sont achevés ; **#587** n'est donc plus bloqué par la release. Les commentaires propriétaire du 2026-07-15 sur **#245**/**#551** et leurs corps de ticket resserrés restent valides.

### Regroupements pertinents

- **Pipeline de hauteur 16 bits** (#581 → #587 → {#588 ‖ #589} → #590 ; l'ADR #586 est achevé) : le verrou de release est levé et #587 peut démarrer.
...
|---|-------|------------|------------|----------------|-----------------------------|
| [#587](https://github.com/NikolayDA/picture_helper/issues/587) | [16 bits] Modèle de domaine HEIGHT et ProjectHistory sans perte | 🟠 Élevée | 🟠 Élevée (très large) | Opus 4.8 · élevé | **Ready for PR** – #586 et release v2.6.0 sont achevés ; aucune dépendance ouverte ne reste. |
...
1. **#587** — démarrer le modèle de domaine HEIGHT 16 bits canonique ; l'ADR et le verrou de release sont achevés.
2. **#592** — démarrer en parallèle le pipeline de géométrie 3D ; #586 et #591 sont achevés.
3. **#606** — documenter les nouveaux contrôles de mise à jour/IA dans les six versions d'ANLEITUNG.
4. **#551** — implémenter le modèle hybride convenu (CodeQL automatique, Codex uniquement manuel via `workflow_dispatch`).
5. **#597 + #598** — fermer les deux lacunes de couverture dans un petit PR ; les autres tickets 16 bits/3D suivent leurs dépendances documentées.

*Dérive :* cette mise à jour post-release aligne l'instantané sur la release publiée, les clôtures #580/#585 et la nouvelle lacune documentaire #606 ; elle résout #607. Les futures mises à jour continuent de revérifier statuts, checklists et dépendances en direct plutôt que de reporter un horodatage.
