...
**EufyMake #681/#687–#691 :** les PR #948, #951–#953, #956 et #959 sont fusionnées. Les 27 cellules d'import obligatoires sans impression sont terminées dans Studio 4.2.2. Outre HEIGHT natif 8/16 bits, le recadrage COLOR/HEIGHT et `Gloss Varnish`, le test prouve que des dimensions en pixels différentes avec le même ratio sont acceptées, tandis qu'un ratio HEIGHT différent est rejeté avec `Depth image ratio does not match the original image`. I-09 (`.empf`) reste non bloquant. Seules les mesures physiques E1 de #688–#690 et la revue finale de #687 restent ouvertes.
