...
**EufyMake #681/#687–#691 :** les fixtures, modèles de protocole et la gouvernance approuvée sont reflétés dans les tickets ; la PR ouverte #948 porte le jeu à 33 fixtures, ajoute une cellule alpha/couverture, une paire COLOR/HEIGHT de mêmes dimensions et un inspecteur avant import, et documente deux imports Studio (4.2.2) sans impression. #687 est à 16/18 critères ; seuls I-06 (dossier/manifeste) et la revue finale après les tests réels restent ouverts.
...
| [#688](https://github.com/NikolayDA/picture_helper/issues/688) | Valider la profondeur de bits/sémantique HEIGHT sur du matériel réel | 🟠 Élevé (affecte directement la hauteur du relief) | 🔴 Élevé (imprimante physique, fixtures, protocole de mesure) | – (aucun agent ; matériel EufyMake réel requis) | En revue + bloqué (externe) : la PR #948 achève le travail préparatoire (33 fixtures dont alpha/couverture, paire COLOR/HEIGHT de mêmes dimensions, inspecteur avant import) et documente deux imports Studio ; les mesures physiques d'impression, de relief et en mm restent ouvertes |
...
3. Revoir et fusionner **#948** ; puis, avant la prochaine session Studio/imprimante, combler les
   lacunes restantes de #689/#690 (cellules gloss, vrai manifeste d'export pour I-06) et exécuter
   #687 (reste), #688, #689 et #690 en une seule session groupée.
