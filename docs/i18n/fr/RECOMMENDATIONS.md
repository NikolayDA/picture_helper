...
- **#583/#586 (2026-07-15, même jour) :** la curation du scope-freeze/version/CHANGELOG de v2.6.0 (#583) et l'ADR HEIGHT 16 bits (#586) sont achevés et clos ; #584 et #591 sont désormais débloqués.
...
État en direct : **18** tickets ouverts – le même instantané que plus tôt le même jour, mais avec deux sous-tickets clos entre-temps (**#583**, **#586**) et des commentaires du propriétaire mis à jour sur **#245**/**#551**. La vérification des commentaires a trouvé : #245 et #551 ont chacun reçu un nouveau commentaire daté du 2026-07-15 – le propriétaire les a utilisés pour figer la décision stratégique de #551 (modèle hybride : CodeQL automatique + Codex manuel uniquement) et resserrer le périmètre des deux tickets en conséquence ; les deux corps de ticket sont déjà à jour, aucun commentaire supplémentaire de ma part n'était donc nécessaire. Les 16 autres tickets restent sans commentaire.
...
- **Aperçu de relief 3D** (#582 → #591 → #592 → #593 → #594 → #595) : #591 est désormais débloqué puisque #586 est clos – il peut démarrer immédiatement en parallèle de l'implémentation du modèle 16 bits ; #582 reste malgré tout le plus gros bloc d'effort de cette ronde.
...
| [#584](https://github.com/NikolayDA/picture_helper/issues/584) | Release 2.6.0 : gate candidat, cinq artefacts | 🟠 Élevée | 🟠 Élevée | Sonnet 5 · élevé | **Ready for PR** – #583 est clos, plus aucune dépendance ouverte ; les cinq smokes d'artefacts se prêtent bien à une orchestration parallèle par workflow. |
...
| [#591](https://github.com/NikolayDA/picture_helper/issues/591) | [3D] ADR/contrat UX : backend de rendu, fallback, budgets | 🟡 Moyenne | 🟠 Élevée | Opus 4.8 · élevé | **Ready for PR** – #586 est clos, plus aucune dépendance ouverte ; travail pur de concept ADR/UX, peut démarrer en parallèle de l'implémentation du modèle 16 bits. |
| [#592](https://github.com/NikolayDA/picture_helper/issues/592) | [3D] Pipeline de géométrie/normales/décimation sans Qt | 🟡 Moyenne | 🟠 Élevée (très large) | Opus 4.8 · élevé | **Blocked** – attend #591. |
...
| [#582](https://github.com/NikolayDA/picture_helper/issues/582) | [Epic] Véritable aperçu de relief 3D | 🟡 Moyenne | 🟠 Élevée (très large) | – (epic de suivi) | **In progress** – avance via #591→…→#595 ; #591 désormais prêt à démarrer (#586 clos). |
...
1. **#584** — traiter dès maintenant le gate candidat de v2.6.0 : #583 est clos, plus aucune dépendance ouverte ; fige le candidat de release sur les cinq artefacts.
2. **#591** — démarrer dès maintenant l'ADR/contrat UX 3D plutôt que d'attendre que #586 soit « accepté » : #586 est clos, #591 bloque #592–595 et peut explicitement avancer en parallèle de l'implémentation du modèle 16 bits (#587+).
...
*Dérive :* revérifier en direct le nombre de tickets ouverts avant chaque mise à jour, sans le reporter tel quel – au sein de cette même journée, deux sous-tickets (#583, #586) ont été clos et ont débloqué deux tickets en aval (#584, #591) ; un simple instantané horodaté n'aurait pas capté cela.
