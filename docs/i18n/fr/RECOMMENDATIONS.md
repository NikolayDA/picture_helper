...
## État actuel (2026-07-26, audit des tickets : trois nouvelles épopées)

Ruff, mypy et la suite de tests locale restent la base avant tout nouveau PR. Depuis la dernière mise à jour (2026-07-23), aucun ticket n'a été fermé ; le propriétaire du dépôt a en revanche créé trois nouvelles épopées totalisant 14 sous-tickets, faisant passer l'état en direct de 2 à **19** tickets ouverts :
...
Les fils de commentaires de #245 et #656 ont été revérifiés : aucun nouveau commentaire depuis le dernier état (#245 pour la dernière fois le 2026-07-15, #656 jamais) ; les deux restent, sans changement, de purs trackers externes/opérationnels sans lien avec le code, donc aucune mise à jour de ticket n'était nécessaire. Aucun autre ticket n'a été fermé depuis la mise à jour du 07-23 — à une exception près dans cette même fenêtre : **#677** (code mort détecté par le scan vulture) a été ouvert puis fermé le 2026-07-26 via le PR #679 (commit `45ebac3`), avant le début de cet audit ; il n'apparaît donc à juste titre pas dans la liste des 19 tickets ouverts.

État en direct : **19** tickets ouverts (17 nouveaux : #680–#696 ; #656/#245 inchangés, externes).

### Résultat de la revue

- **Aucun nouveau commentaire** sur #245/#656 depuis le dernier tour – aucune mise à jour nécessaire sur ces tickets.
- **Les 17 nouveaux tickets sont entièrement spécifiés :** chacun contient contexte, objectif, non-objectifs/limites de périmètre et une liste détaillée de critères d'acceptation ; aucun n'est sous-spécifié. Le facteur limitant n'est pas la description mais des dépendances réelles : l'épopée #681 (EufyMake) a besoin de matériel cible physique pour #688–#690, l'épopée #680 a besoin de l'ordre gel de périmètre/test de régression → build candidat → publication, et l'épopée #682 a besoin de l'ADR (#692) avant toute implémentation.
- **Immédiatement lançables sans dépendance externe :** #683, #684 (épopée #680) ainsi que #692 (épopée #682) et la partie ossature de #687 (épopée #681, hors tests matériels proprement dits).
...
|---|-------|------------|------------|------------------------------|------------------|
| [#680](https://github.com/NikolayDA/picture_helper/issues/680) | [Épopée] Stabilisation v2.7.x – livrer le correctif GL | 🟠 Élevée (livre le correctif de ressources GL fusionné aux utilisateurs) | 🟠 Élevée (4 sous-tickets, pipeline de release + recette matérielle) | – (épopée ; Sonnet, moyen pour le suivi) | En cours – lancer d'abord #683/#684 |
| [#683](https://github.com/NikolayDA/picture_helper/issues/683) | Gel de périmètre, coupe de version, notes de release 2.7.1 | 🟠 Élevée (prérequis pour tout le release correctif) | 🟢 Faible (revue de diff + métadonnées de version, processus établi) | Sonnet, moyen | Prêt à démarrer |
...
1. Lancer d'abord **#683** (gel de périmètre 2.7.1) – petit, débloque #685/#686, amène le correctif GL aux utilisateurs plus vite.
2. Lancer **#684** (test ressources GL/régression) en parallèle de #683 – seule preuve solide pour le PR #676, indépendante de la coupe de version.
...
- **2026-07-26 (audit des tickets : trois nouvelles épopées)** — le propriétaire du dépôt a créé les épopées #680 (stabilisation v2.7.x/2.7.1), #681 (profil cible EufyMake) et #682 (moteur de tonalité COLOR) avec 14 sous-tickets ; aucun ticket fermé. #245/#656 sans nouveau commentaire, inchangés, externes. Immédiatement lançables sans dépendance externe : #683, #684, #692 et l'ossature de #687. L'état en direct est passé de 2 à 19 tickets ouverts.
