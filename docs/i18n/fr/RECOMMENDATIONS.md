...
| [#974](https://github.com/NikolayDA/picture_helper/issues/974) | Protéger ANLEITUNG.pdf face à ANLEITUNG.md (garde manquante) | 🟡 Moyenne (le PDF du manuel livré peut se périmer ; la dérive s'est réellement produite avec #953) | 🟢 Faible (un test hors réseau plus une ligne de documentation ; comparaison par octets exclue) | Sonnet, moyen | Prêt à démarrer – implémenter la garde git de co-modification ; preuve rouge sur `ac64c3b`, verte sur `91b32b4` et HEAD |
