...
Slider: Prototyp-Range-Control (`input[type=range]`) mit 4 px Groove, oben
9 px/unten 2 px Abstand, gefüllter Strecke in `accent`, ungefüllter Strecke
im `border`-Ton (je Radius 2), Griff 14 px `accent` (Radius 7), Fokus =
2 px Rand am Griff; Klickziel ist der gesamte Groove.
