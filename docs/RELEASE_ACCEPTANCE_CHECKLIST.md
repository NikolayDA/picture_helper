...
| `MALWARE-01` | Pre-Release | SHOULD | Security-Owner | Scannerzustand `PASS`, `FAIL` oder sichtbar nicht verfügbar; Malware-Fund blockiert immer |
