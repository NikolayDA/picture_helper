...
- **Commits im Fenster:** 4 (`v2.7.1..<Kandidat>`, siehe Tabelle – jede Zeile
  entspricht genau einem Commit).
- **Protokollierter Kandidaten-SHA:** `49b75b25e2a7804395c4f96dc7015391c2a7726d`
  (`feat: weise die Herkunft des geprüften Codes in der Abnahme-Evidenz aus`,
  Squash-Merge von PR #738 auf `main`)
...
- **Nachtrag des Kandidaten-SHA für #738** (dieser Nachtrag): trägt
  `49b75b25e2a7804395c4f96dc7015391c2a7726d` als Kandidaten nach und macht
  `--require-pin` wieder grün. Ändert ausschließlich `docs/history/**`.
...
Der vorherige Protokoll-Commit `36acb86` (#736) steht nicht mehr hier, sondern
mit vollem SHA in der Tabelle oben: Der Kandidat ist durch #738 über ihn
hinweggewandert, damit liegt er jetzt **innerhalb** des Fensters.
