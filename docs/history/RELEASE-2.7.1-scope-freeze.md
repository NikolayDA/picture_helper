...
|---|---|
| `make check` | grün: ruff „All checks passed", mypy „no issues found in 70 source files", pytest **2065 passed, 6 skipped, 14 deselected** |
