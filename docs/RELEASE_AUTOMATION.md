...
(`failed_job_conclusions`), Meldung und Job-Zusammenfassung nennen sie mit;
bei `startup_failure` sagen Meldung und Abhilfe ausdrücklich, dass keine
Prüfung lief und kein Joblog existiert.
